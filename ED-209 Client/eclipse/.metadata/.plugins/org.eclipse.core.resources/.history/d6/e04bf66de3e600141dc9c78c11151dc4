...
import disconnected.module.modules.*;
...
public class ModuleManager {
	...
	public ModuleManager() {
		...
		this.activeModules.add(new ArmDerp());
		this.activeModules.add(new AutoSpawn());
		this.activeModules.add(new AutoWalk());
		//this.activeModules.add(new BowSpam());
		this.activeModules.add(this.bowAimBotModule = new BowAimBot());
		this.activeModules.add(new ClickAimBot());
		this.activeModules.add(new Criticals());
		this.activeModules.add(new Disconnect());
		this.activeModules.add(this.entityOverayModule = new EntityOverlay());
		...
		this.activeModules.add(new KillAuraMob());
		this.activeModules.add(new KillAuraPlayer());
		this.activeModules.add(new MagicCarpet());
		this.activeModules.add(this.MobESPModule = new MobESP());
		this.activeModules.add(new MobTracers());
		this.activeModules.add(new NoBlind());
		this.activeModules.add(new NoFall());
		this.activeModules.add(new NoFatigue());
